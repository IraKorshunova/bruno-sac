...
if __name__ == "__main__":
    ...
    train_params = defaults.train_cheetah_velocities
    test_params = defaults.test_cheetah_velocities

    train_envs_names, test_envs_names = env_utils.get_envs(env_type='HalfCheetahVelEnv',
    ...
    if args.oracle:
        replay_buffer = EnvironmentsReplayBuffer(env_params=test_params, obs_dim=obs_dim, act_dim=action_dim,
                                                 size=int(1e6), encoding=None)
        algorithm = OracleSAC(train_envs=test_envs, test_envs=test_envs,
    ...
    if args.train:
        ...
        algorithm.train(max_episodes=2500, n_exploration_episodes=250,
                        ...
                        replay_buffer=replay_buffer,
                        n_save_iter=20, plot_n_steps=0, n_test_episodes=5, plot_diagnostics=False,
                        save_dir=save_dir)
    else:
